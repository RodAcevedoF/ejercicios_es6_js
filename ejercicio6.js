...
const sumScore = exams.reduce((prev, curr) => prev + curr.score, 0)
console.log(sumScore)
/*6.2 Dado el mismo array, haz una suma de todos las notas de los examenes de los 
alumnos que esten aprobados usando la función .reduce().*/

const passingScores = exams.reduce((prev, curr) => {
    return curr.score >= 5 ? prev + curr.score : prev
}, 0)
console.log(passingScores)

//6.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().

const avgScore = exams.reduce((prev, curr) => prev + curr.score, 0) / exams.length
